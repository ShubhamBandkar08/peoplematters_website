...
test.describe('Technology Page', () => {
    ...
    test('TC_01 : Validate technology Page Loads Successfully', async ({ page }) => {
        const technologyobj = new TechnologyPage(page);
        await technologyobj.tehcnologyPageLink.click();
        await expect(page).toHaveURL(/technology/);
    })

    test('TC_02 : Validate technology Page Section Labels', async ({ page }) => {
        const technologyobj = new TechnologyPage(page);
        await technologyobj.tehcnologyPageLink.click();
        await page.waitForTimeout(6000);
    ...
    test('TC_03 : Validate technology page sub-category navigation', async ({ page }) => {
    ...
    test('TC_04 : Validate technology page Sticky header subcategory navigation', async ({ page }) => {
    ...
    test('TC_05 : Validate technology Page Articles navigation and load successfully', async ({ page }) => {
