...
const { TalentAcquisitionPage } = require('../pages/talentacquisition.page');
test.describe('Talent Acquisition Page', () => {
    test.use({
    ...
    test('TC_01 : Verify talent Acquisition Page Loads Successfully', async ({ page }) => {
        const strategyPage = new TalentAcquisitionPage(page);
        await strategyPage.talentAcquisitionPageLink.click();
        await expect(page).toHaveURL(/talent-acquisition/);
    })

    test('TC_02 : Verify talent Acquisition Section Labels', async ({ page }) => {
        const talentacquisitionobj = new TalentAcquisitionPage(page);

        // Click Strategy link
        await talentacquisitionobj.talentAcquisitionPageLink.click();
        await page.waitForTimeout(6000);
    ...
    test('TC_03 : Validate talent Acquisition page sub-category navigation', async ({ page }) => {
    ...
    test('TC_04 : Validate talent Acquisition page Sticky header subcategory navigation', async ({ page }) => {
    ...
    test('TC_05 : Validate talent Acquisition Page Articles navigation and load successfully', async ({ page }) => {
